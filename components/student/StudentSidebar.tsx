    ...
    <>
      ...
      >
        <div className="flex items-center justify-between p-4 border-b dark:border-gray-700">
          <h1 className="text-xl font-bold text-indigo-600 dark:text-indigo-400">{t('sidebar.studentApp')}</h1>
        ...
        <div className="p-4 border-t dark:border-gray-700">
            ...
            >
              ...
              <span className="mx-4 font-medium">{t('sidebar.attendanceCode')}</span>
            </button>
        </div>
      </div>
    </>
